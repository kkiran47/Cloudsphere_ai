...
import { Cloud, Mail, Lock, User, Loader2, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen ambient-bg bg-slate-50 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        ...
        <p className="mt-3 text-center text-slate-600 dark:text-slate-400 font-medium">
          Already have an account? <Link to="/login" className="font-bold text-brand-600 dark:text-brand-400 hover:text-brand-500 transition-colors">Sign in</Link>
        </p>
      </motion.div>
